...
public class PokemonSwapButton : Button
{
    ...
    public override void OnPointerClick(PointerEventData eventData)
    {
        ...
        if(owner.ForceSwap)
        {
            if(BattleManager.Instance.BattleField.ChangeFirstPokemon(BattleManager.Instance.PlayerTrainer.PokemonTeam[index]))
        ...
        else
        {
            ...
            {
                BattleManager.Instance.SelectAction(new SwapPokemonAction(BattleManager.Instance.PlayerTrainer.PokemonTeam[index]));
                owner.MenuButton.Activate();
            }
            else
                Debug.Log("Pokemon Fainted !!!");
